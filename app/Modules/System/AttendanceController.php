                ...
                ->addColumn('action', function ($data) {
                    return " <div class=\"dropdown\">
                              ...
                              <ul class=\"dropdown-menu\">
                                <li class=\"dropdown-item\"><a href=\"" . route('system.attendance.show', $data->id) . "\">" . __('View') . "</a></li>
...
//
    ...
    public function attendanceGroupStore(Request $request){
        ...
        $this->validate($request,[
            ...
            'cleaner_id.*' =>'exists:staff,id','unique:attendance,cleaner_id,NULL,id,date,'.date("Y-m-d"),
            Rule ::exists('attendance')->where(function ($query) {
