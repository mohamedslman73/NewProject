...
return [
    ...
    [
        'name' => __('Bus Traking'),
        'description' => __('Bus Traking'),
        'permissions' => [
            'view-Bus-Traking'         =>['system.traking.index','system.traking.show'],
            'create-Bus-Traking'       =>['system.traking.create','system.traking.store'],
            'delete-one-Bus-Traking'   =>['system.traking.destroy'],
            'update-Bus-Traking'       =>['system.traking.edit','system.traking.update'],
        ]
    ],
    [
        'name' => __('Attendance'),
    ...
    */
    ...
    [
        'name' => __('Visa Traking'),
        'description' => __('Visa Traking'),
        'permissions' => [
            'view-Visa-Traking'         =>['system.visa-tracking.index','system.visa-tracking.show'],
            'create-Visa-Traking'       =>['system.visa-tracking.create','system.visa-tracking.store'],
            'delete-one-Visa-Traking'   =>['system.visa-tracking.destroy'],
            'update-Visa-Traking'       =>['system.visa-tracking.edit','system.visa-tracking.update'],
        ]
    ],
