                ...
                ->addColumn('action', function ($data) {
                    return " <div class=\"dropdown\">
                              ...
                              <ul class=\"dropdown-menu\">
                                <li class=\"dropdown-item\"><a href=\"" . route('system.certificates.show', $data->id) . "\">" . __('View') . "</a></li>
...
//
    ...
    public function update(Request $request,Certificate $certificates)
    {
        ...
        if ($certificates->update($theRequest)) {

            return redirect()
                ->route('system.certificates.edit', $certificates->id)
                ->with('status', 'success')
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Request $request,Certificate $certificates)
    {
        $certificates->delete();
        if ($request->ajax()) {
