                                    ...
                                    <div class="form-group col-sm-6{!! formError($errors,'name',true) !!}">
                                        ...
                                        <div class="form-group col-sm-12{!! formError($errors,'item_category_id',true) !!}">
                                            <div class="controls">
                                                ...
                                                {!! Form::select('item_category_id',isset($result->id) ? [$result->item_category_id =>$result->item_categories->name]:[''=>__('Select Item Category')],isset($result->id) ? $result->item_category_id:old('item_category_id'),['style'=>'width: 100%;' ,'id'=>'item_category_id','class'=>'form-control col-md-12']) !!}
