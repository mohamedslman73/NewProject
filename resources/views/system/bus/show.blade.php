                    ...
                    <div class="col-md-12">
                        <section id="spacing" class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">
                                    {{--<span style="float: right;"><a class="btn btn-outline-primary"  href="javascript:void(0);" onclick="urlIframe('{{route('system.traking.index').'?bus_id='.$result->id}}')"><i class="fa fa-pencil"></i> {{__('Bus Traking')}}</a></span>--}}
                                    <a class="btn btn-outline-primary" style="float: right" href="{{route('system.traking.index').'?bus_id='.$result->id}}" target="_blank">Bus Traking</a>
                                </h4>
