            ...
            <div class="content-body">
                ...
                <section id="server-processing">
                    <div class="row">
                            ...
                            @endif
                            {!! Form::open(['route' => isset($result->id) ? ['system.category.update',$result->id]:'system.category.store','method' => isset($result->id) ?  'PATCH' : 'POST']) !!}
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h2>{{__('Item Category Data')}}</h2>
                                    </div>
                                    <div class="card-block card-dashboard">
                                        ...
                                        <div class="form-group col-sm-12{!! formError($errors,'parent_id',true) !!}">
                                            <div class="controls">
                                                ...
                                                {!! Form::select('parent_id',['0'=>'Select Parent Category']+array_column($itemCategory->toArray(),'name','id'),isset($result->id) ? $result->parent_id:old('parent_id'),['class'=>'form-control']) !!}
                                            </div>
