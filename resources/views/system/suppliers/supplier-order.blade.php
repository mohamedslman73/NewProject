                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('created_at1',__('Supplier Order Created From')) }}
                                    {!! Form::text('supplier_order_created_at1',null,['class'=>'form-control datepicker','id'=>'created_at1']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('created_at2',__('Supplier Order Created To')) }}
                                    {!! Form::text('supplier_order_created_at2',null,['class'=>'form-control datepicker','id'=>'created_at2']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('created_at1',__('Slice Created From')) }}
                                    {!! Form::text('expense_created_at1',null,['class'=>'form-control datepicker','id'=>'created_at1']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('created_at2',__('Slice Created To')) }}
                                    {!! Form::text('expense_created_at2',null,['class'=>'form-control datepicker','id'=>'created_at2']) !!}
                                </fieldset>
                            </div>

                            {{--<div class="col-md-6">--}}
                                {{--<fieldset class="form-group">--}}
                                    {{--{{ Form::label('total_order_price1',__('Total Order Price From')) }}--}}
                                    {{--{!! Form::number('total_order_price1',null,['class'=>'form-control','id'=>'id']) !!}--}}
                                {{--</fieldset>--}}
                            {{--</div>--}}
                            {{--<div class="col-md-6">--}}
                                {{--<fieldset class="form-group">--}}
                                    {{--{{ Form::label('total_order_price2',__('Total Order Price To')) }}--}}
                                    {{--{!! Form::number('total_order_price2',null,['class'=>'form-control','id'=>'id']) !!}--}}
                                {{--</fieldset>--}}
                            {{--</div>--}}
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    {{ Form::label('name',__('Supplier Name')) }}
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('supplier_id',[''=>__('Select Supplier')],null,['style'=>'width: 100%;' ,'id'=>'supplier_id','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                        </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        ajaxSelect2('#supplier_id','supplier','',"{{route('system.ajax.get')}}");
