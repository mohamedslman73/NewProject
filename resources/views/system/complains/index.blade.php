                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::textarea('comment',null,['class'=>'form-control','id'=>'description','rows'=>2]) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('project_id',['Select Project']+$projects,null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('Complain OF Staff',__('Complain OF Staff')) }}
                                    <div>
                                        {!! Form::select('complain_of_staff_id',[''=>__('Select Staff')],null,['style'=>'width: 100%;' ,'id'=>'complain_of_staff_id','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        ajaxSelect2('#complain_of_staff_id','staff','',"{{route('system.ajax.get')}}");
        ...
        {{--function showData($id) {--}}
            {{--$('#modal-data-content').html('<b style="text-align: center">{{__('Loading...')}}</b>');--}}
            {{--$('#modal-data').modal('show');--}}
            {{--$.get('{{route('system.complain.show',$id)}}/'+$id,function ($data) {--}}
                {{--$('#modal-data-content').html($data);--}}
            {{--})--}}
        {{--}--}}
