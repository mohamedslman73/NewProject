            ...
            <div class="content-body">
                ...
                <section id="server-processing">
                    <div class="row">
                        ...
                        @endif
                        {!! Form::open(['route' => isset($result->id) ? ['system.traking.update',$result->id]:'system.traking.store','method' => isset($result->id) ?  'PATCH' : 'POST','files'=> true]) !!}
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-block card-dashboard">
                                    ...
                                    <div class="form-group col-sm-6{!! formError($errors,'number_km',true) !!}">
                                        <div class="controls">
                                            {!! Form::label('number_km', __('Number Km')) !!}
                                            {!! Form::number('number_km',isset($result->id) ? $result->number_km:old('number_km'),['class'=>'form-control']) !!}
                                        </div>
                                        {!! formError($errors,'number_km') !!}
                                    </div>
                                    ...
                                    {{--<div class="form-group col-sm-12{!! formError($errors,'date',true) !!}">--}}
                                        {{--<div class="controls">--}}
                                            {{--{!! Form::label('date', __('Date of Traking')) !!}--}}
