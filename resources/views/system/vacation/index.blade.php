                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('num_of_days',__('Num Of Days')) }}
                                    {!! Form::number('num_of_days',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('staffSelect2',__('Added To')) }}
                                    <div>
                                    {!! Form::select('added_to',[''=>__('Select Staff')],isset($result->id) ? $result->added_to:old('added_to'),['style'=>'width: 100%;' ,'id'=>'added_to','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('staff_id',[''=>__('Select Staff')],isset($result->id) ? $result->staff_id:old('staff_id'),['style'=>'width: 100%;' ,'id'=>'staffSelect2','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('vacation_type_id',['0'=>'Select Vacation Type']+$vacation_types,isset($result->id) ? $result->vacation_type_id:old('vacation_type_id'),['class'=>'form-control']) !!}
                                    </div>
                                </fieldset>
                            </div>
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        ajaxSelect2('#added_to','staff','',"{{route('system.ajax.get')}}");
