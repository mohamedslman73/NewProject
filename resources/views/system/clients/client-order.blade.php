                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('created_at1',__('Client Order Created From')) }}
                                    {!! Form::text('client_order_created_at1',null,['class'=>'form-control datepicker','id'=>'created_at1']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('created_at2',__('Client Order Created To')) }}
                                    {!! Form::text('client_order_created_at2',null,['class'=>'form-control datepicker','id'=>'created_at2']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('created_at1',__('Slice Created From')) }}
                                    {!! Form::text('revenue_created_at1',null,['class'=>'form-control datepicker','id'=>'created_at1']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('created_at2',__('Slice Created To')) }}
                                    {!! Form::text('revenue_created_at2',null,['class'=>'form-control datepicker','id'=>'created_at2']) !!}
                                </fieldset>
                            </div>
                            <div class="col-md-12">
                                <fieldset class="form-group">
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <div>
                                        {!! Form::select('client_id',[''=>__('Select Client')],null,['style'=>'width: 100%;' ,'id'=>'client_id','class'=>'form-control col-md-12']) !!}
                                    </div>
                                </fieldset>
                            </div>
                        </div>
