                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                                ...
                                                                $credit = $client['init_credit'];
                                                                @endphp
                                                                <tr style="background-color: #00BCD4" ><td colspan="3">{{__('INITIAL Credit')}}</td><td colspan="3">{{$credit}}</td></tr>
                                                @foreach($tableColumns as $value)


                                                        <tr style="background-color: @php if($value['type'] == 'supplier_order') echo 'yellow';else echo 'greenyellow';@endphp">
                                                            <td>{{$value['id']}}</td>
                                                            @if($value['type'] =='client_order')
                                                            <td>Client Order</td>
                                                            @elseif($value['type'] == 'client_revenue')
                                                            ...
                                                            @if($value['type'] == 'client_order')
                                                                ...
                                                                <td>{{$credit -= $value['total_price']}}</td>

                                                            @elseif($value['type'] == 'client_revenue')

                                                                <td>{{ $credit += $value['amount'] }}</td>

                                                                @endif

                                                            <td>{{$value['date']}}</td>
                                                            @if($value['type'] == 'client_order')
                                                            <td><a target="_blank" href = "{{route('system.client-orders.show',$value['id'])}}">View</a></td>
                                                            @elseif($value['type'] == 'client_revenue')
                                                                <td><a target="_blank" href = "{{route('system.profits.show',$value['id'])}}">View</a></td>
                                                            @endif
                                                        </tr>
                                                @endforeach
