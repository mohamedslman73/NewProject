                                    ...
                                    @if($result->image)
                                        <div class="media-left pl-2 pt-2">
                                            <a href="jaascript:void(0);" class="profile-image">
                                                <img title="{{$result->name}}" src="{{asset('storage/app/'.imageResize($result->avatar,70,70))}}"  class="rounded-circle img-border height-100"  />
                                            </a>
                                        </div>
                                    @endif
                        ...
                        <div class="col-md-12">
                            <section id="spacing" class="card">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        {{__('Client Info')}}
                                        <span style="float: right;"><a class="btn btn-outline-primary"  href="javascript:void(0);" onclick="urlIframe('{{route('system.client.edit',$result->id)}}')"><i class="fa fa-pencil"></i> {{__('Edit')}}</a></span>
                                    </h4>
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">
                                        ...
                                        <a class="btn btn-outline-primary"style="float: right;"  href="{{route('system.project.index').'?client_id='.$result->id}}" target="_blank">{{$result->project->count()}} Projects</a>
                                    </h4>
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tr>
                                                    <td>Rest</td>
                                                    <td>@php echo  ( $result->ini_credit + $total_orders ) - $total_revenue; @endphp</td>
                                                </tr>
