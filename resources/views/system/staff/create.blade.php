                                    ...
                                    <div class="card-block card-dashboard">
                                      ...
                                      <div class="form-group col-sm-6{!! formError($errors,'date_of_visa_issue',true) !!}">
                                        ...
                                        <div class="form-group col-sm-4{!! formError($errors,'weight',true) !!}">
                                            ...
                                            {!! formError($errors,'clothes_size') !!}
                                        </div>    <div class="form-group col-sm-4{!! formError($errors,'clothes_size',true) !!}">
                                            <div class="controls">
                                                {!! Form::label('length', __('length (By Cm)').':') !!}
                                                ...
                                                @foreach($staff_clothes as $key=> $row)
                                                    ...
                                                    <div class="cleanersRow" >
                                                        ...
                                                        <div class="form-group col-sm-5{!! formError($errors,'clothe_id',true) !!}">
                                                            <div class="controls">
                                                                {!! Form::label('Clothes', __('Clothes').':') !!}
                                                                {!! Form::select('clothe_id[]',[__('Select Clothes')]+$clothe,isset($result->id) ? $row['clothe_id']:old('clothe_id'),['class'=>'form-control clothe_id','multiple'=>'multiple']) !!}
                                                            </div>
                                            ...
                                            @else
                                                <div class="cleanersRow" style="display: table;width: 100%">
                                                    ...
                                                    <div class="form-group col-sm-5{!! formError($errors,'clothe_id',true) !!}">
                                                        <div class="controls">
                                                            {!! Form::label('Clothes', __('Clothes').':') !!}
                                                            {!! Form::select('clothe_id[]',[__('Select Clothes')]+$clothe,isset($result->id) ? $result->clothe_id:old('clothe_id'),['class'=>'form-control clothe_id','multiple'=>'multiple']) !!}
                                                        </div>
