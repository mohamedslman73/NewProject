            ...
            <div class="modal-body">
                <div class="form-group col-sm-6{!! formError($errors,'medical',true) !!}">
                    <div class="controls">
                        ...
                        {!! Form::select('medical',[''=>'Medical','yes'=>__('Yes'),'no'=>__('No')],null,['class'=>'form-control']) !!}
                    </div>
                ...
                <div class="form-group col-sm-6{!! formError($errors,'visa_status',true) !!}">
                    <div class="controls">
                        ...
                        {!! Form::select('blood',[''=>'Select Blood Test Status','yes'=>__('Yes'),'no'=>__('No')],null,['class'=>'form-control']) !!}
                    </div>
                ...
                <div class="form-group col-sm-6{!! formError($errors,'visa_status',true) !!}">
                    <div class="controls">
                        ...
                        {!! Form::select('finger_print',[''=>'Select Finger Print Test Status','yes'=>__('Yes'),'no'=>__('No')],null,['class'=>'form-control']) !!}
                    </div>
                    {!! formError($errors,'visa_status') !!}
                </div>
